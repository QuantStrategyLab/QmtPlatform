...
def test_qsl_metadata_has_runtime_platform_fields() -> None:
    ...
    assert requires["quant_platform_kit"] == "1a6ed98eea5d69ebe6d09ec1cb1e6ec10c4faeed"
    assert requires["cn_equity_strategies"] == "df32d12bace88ee414d9c586847f87e5b56ebe93"
